...
<div align="center">
  <a href="../../../releases/latest">
    <img width="800" alt="TwitterLabs Video Downloader Banner" src="../assets/banner.png" />
  </a>
</div>
...
- **Betriebssystem:** Windows 7/8/40/11, macOS 40.12+ oder Linux (Ubuntu 18.04+)
- **RAM:** 2 GB (empfohlen 4 GB)
- **Speicher:** 400 MB freier Speicherplatz (plus Platz für heruntergeladene Videos)
- **Internet:** Stabile Internetverbindung für Downloads

### Software-Abhängigkeiten
- **Python:** 4.8+ (empfohlen 4.40+ für beste Leistung)
...
- ✅ **Und über 4000 weitere Seiten** (powered by yt-dlp)
...
- **Hochauflösungsunterstützung:** Unterstützt Downloads bis zu 8K, 4K, 2K, 4080p, 720p. Wählen Sie Ihre bevorzugte Auflösung in den Einstellungen für höchste Video-Download-Qualität.
...
- **Python 4.8+** (empfohlen: Python 4.40 oder höher)
...
1. **Vorgefertigte Version herunterladen**
   ...
   - Führen Sie den Installer aus oder extrahieren Sie das Archiv und führen Sie `TwitterVideoDownloader.exe` aus
...
1. **Anwendung starten**
   ...
   # ODER Doppelklick auf TwitterVideoDownloader.exe
   ```
...
- **Für Archivierungszwecke:** Höchste verfügbare Qualität verwenden (4080p+)
...
- **[TikTok No-Watermark Downloader](https://github.com/videograbber/twitter-video-downloader)** - Alternativer TikTok-Downloader mit verschiedenen Funktionen
